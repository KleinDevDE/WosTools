    ...
    <div class="max-w-7xl mx-auto px-4 py-6 pb-safe">
      ...
      <div v-else class="space-y-4">
        ...
        >
          <div class="flex items-center p-4">
            ...
            <div class="flex-1 ml-4 min-w-0">
              ...
              <p class="text-sm text-navy-400 mt-1">{{ album.puzzles_count || 0 }} puzzles</p>

              <div v-if="album.total_pieces > 0" class="mt-3">
                <div class="flex items-center justify-between text-xs mb-1">
                  <span class="text-navy-400">Progress</span>
        ...
        <div v-if="albums.length === 0 && !albumStore.loading" class="text-center py-12">
          <p class="text-navy-500 text-lg">No albums found</p>
        </div>
      </div>
    </div>
  </div>
